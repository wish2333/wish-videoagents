...
typography:
  hero-display:
    fontFamily: "OPPO Sans 4.0, Dream Han Sans HC, LXGW WenKai, Noto Sans CJK Regular, Source Sans Pro, sans-serif"
    fontSize: 56px
    fontWeight: 600
    lineHeight: 1.07
  ...
  display-lg:
    ...
    letterSpacing: 0
  display-md:
    fontFamily: "OPPO Sans 4.0, Dream Han Sans HC, LXGW WenKai, Noto Sans CJK Regular, IBM Plex Serif, sans-serif"
    fontSize: 34px
    fontWeight: 600
    lineHeight: 1.47
...
SF Pro is Apple's proprietary system font. On this Windows system, the following substitution stack is used (defined in `src/compositions/reading-history/fonts.ts`):

- **DISPLAY_FONT** (headlines): `"OPPO Sans 4.0", "Dream Han Sans HC", "LXGW WenKai", "Noto Sans CJK Regular", "Source Sans Pro", sans-serif`
- **BODY_FONT** (body/UI): `"OPPO Sans 4.0", "Dream Han Sans HC", "LXGW WenKai", "Noto Sans CJK Regular", "IBM Plex Serif", sans-serif`
- **QUOTE_FONT** (decorative): `"Hina Mincho", "LXGW WenKai", "Noto Serif CJK SC", "IBM Plex Serif", serif`

Priority: OPPO Sans 4.0 (modern, Apple-like geometric) > Dream Han Sans HC (27 weights, CJK primary) > LXGW WenKai (warm calligraphic) > Noto Sans CJK (Google fallback). All fonts are SIL/OFL licensed.
